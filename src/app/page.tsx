        ...
        {/* sigIn inicio */}
          <a href="" className="flex items-center gap-3 text-left hover:text-gray-50 transition-colors">
            ...
            <p className='text-sm leading-snug max-w-[140px] '>
              <a href="" className='underline '>Crie sua conta</a> e salve suas memórias
            </p>
          </a>
          {/* sigIn fim */}
          ...
          <div className='space-y-5'>
            ...
            <div className='max-w-[420px] space-x-1'>
              ...
              <p className='text-lg leading-relaxed'>
                Colencione momentos marcantes da sua jornada e compartilhe (se quiser) com o mundo!
              </p>
            </div>
      ...
      <div className="flex flex-col p-16 bg-[url(../assets/bg-stars.svg)] bg-cover">
        <div className="flex flex-1 items-center justify-center">
          <p className="text-center leading-relaxed w-[360px]">
            Você ainda não registrou nenhuma lembraça, começe a{" "}
